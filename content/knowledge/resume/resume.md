...
id: 'resume'
title: 'Résumé'
summary: "Matt Trifilo's published résumé: roles since 2017, what each team owned and shipped, where he is based and his work preferences, and reported outcomes."
...
- Adapted OpenAI's open-source Symphony harness (via an internal fork two colleagues built) to dispatch Claude Code agents that open PRs for opted-in CVE tickets within a minute of intake, running the team's security-fix skill: 17 PRs across 7 services, ~80% hands-free, in month one.
