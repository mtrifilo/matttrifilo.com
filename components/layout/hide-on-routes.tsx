 ...
 * it needs the piece left out from here rather than by a second layout tree.
 * /ask is one: its transcript fills the viewport and cannot have a footer
 * pushing the composer off it. The children stay server components; only the
